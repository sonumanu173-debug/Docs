...
Pedro V2.1 Offers a specific automatic pod offset tuner that
gets the Odometry Pod Offsets for both the forward and the
strafer pod. **Currently only compatible with Pinpoint+2 ODO Setup.**

**Instructions**
- Place the robot in a corner and center it
- Run the offsets tuner
- Take the robot off the corner and Rotate 
  the robot 180 degrees
- Stop the Tuner after you get the offsets and place them into
  loclizer constants.
